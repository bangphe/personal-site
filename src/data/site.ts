export const site = {
  ...
  description:
    'Rizky Purnawan is a full-stack engineer in Sidoarjo, Indonesia, building enterprise platforms, marketplaces and payment integrations in PHP and Node.js since 2012.',
